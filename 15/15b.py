...
def getTotal(components, numbers):
    ...
    for n in range(0, 4):
        ...
        calories += ingredients[components[n]][4] * numbers[n]

    if capacity < 1 or durability < 1 or flavour < 1 or texture < 1 or calories != 500:
        return 0
    else:
...
print 'Winning Combination:', results.keys()[results.values().index(winner)]
